...
insert into "user" (code_expiration_date, date_of_birth, email, first_name, is_registration_complete, is_verified_by_tech_support, last_name, middle_name, passport_data_id, password, phone_number, provider, provider_id, registered_address_id, reset_password_code, residence_address_id, role_id, status, id, blocked)
values (null, null, 'rentit.kg@gmail.com', 'RENTIT', true, true, ' ', ' ', 1, '$2a$10$bEQJAukLr38Kkv2eFCcfh.qWFW2iF7nKaN4xoT039bM6ZSdFxDeBC', ' ', 'local', ' ', 1, null, 1, 3, 'ACTIVE', 1, false);
...
insert into "user" (code_expiration_date, date_of_birth, email, first_name, is_registration_complete, is_verified_by_tech_support, last_name, middle_name, passport_data_id, password, phone_number, provider, provider_id, registered_address_id, reset_password_code, residence_address_id, role_id, status, id, blocked)
values (null, null, 'rentit1.neo@gmail.com', 'Timur', true, true, 'Pratov', ' ', 2, '$2a$10$bEQJAukLr38Kkv2eFCcfh.qWFW2iF7nKaN4xoT039bM6ZSdFxDeBC', ' ', 'local', ' ', 2, null, 2, 2, 'ACTIVE', 2, false);
...
insert into "user" (code_expiration_date, date_of_birth, email, first_name, is_registration_complete, is_verified_by_tech_support, last_name, middle_name, passport_data_id, password, phone_number, provider, provider_id, registered_address_id, reset_password_code, residence_address_id, role_id, status, id, blocked)
values (null, null, 'tilekju@gmail.com', 'Tika', false, false, 'A', ' ', 3, '$2a$12$KvEg83ia5Q9ALBZ5TzfU2uBgnWyjpQJOSY2Xe0ImV2dy63CTEwSN.', ' ', 'local', ' ', 3, null, 3, 1, 'ACTIVE', 3, false);
...
insert into "user" (code_expiration_date, date_of_birth, email, first_name, is_registration_complete, is_verified_by_tech_support, last_name, middle_name, passport_data_id, password, phone_number, provider, provider_id, registered_address_id, reset_password_code, residence_address_id, role_id, status, id, blocked)
values (null, null, 'saikanysh@gmail.com', 'Айканыш', false, false, 'A', ' ', 4, '$2a$10$bEQJAukLr38Kkv2eFCcfh.qWFW2iF7nKaN4xoT039bM6ZSdFxDeBC', ' ', 'local', ' ', 4, null, 4, 1, 'ACTIVE', 4, false);
...
insert into "user" (code_expiration_date, date_of_birth, email, first_name, is_registration_complete, is_verified_by_tech_support, last_name, middle_name, passport_data_id, password, phone_number, provider, provider_id, registered_address_id, reset_password_code, residence_address_id, role_id, status, id, blocked)
values (null, null, 'satybaldievazamat08@gmail.com', 'Азамат', false, false, 'Сатыбалдиев', ' ', 5, '$2a$10$bEQJAukLr38Kkv2eFCcfh.qWFW2iF7nKaN4xoT039bM6ZSdFxDeBC', ' ', 'local', ' ', 5, null, 5, 1, 'ACTIVE', 5, false);
